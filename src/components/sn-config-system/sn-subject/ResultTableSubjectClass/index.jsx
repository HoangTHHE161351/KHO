...
const ResultTableSubjectClass = ({ data, isFetching }) => {
  useEffect(() => {
    const tableEl = document.getElementById("table-subject-class");
  ...
  return (
    ...
    >
      <AppTableContainer id="table-subject-class">
        <AppTable>
          <AppTableHead>
            <HeaderTable />
          </AppTableHead>
...
export default ResultTableSubjectClass;
