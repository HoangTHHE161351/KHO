...
import ResultTableSubjectClass from "./ResultTableSubjectClass";
...
const ImportSubjectClassModal = ({ open, onClose, onSuccess }) => {
  ...
  const fetchImportData = async () => {
    setIsFetching(true);
    try {
      const response = await SubjectService.importSubjectClass(resultData);
  ...
  const downloadExcel = () => {
    try {
      const url = "/excel/ImportSubjectClass.xlsx";
      const link = document.createElement("a");
      link.href = url;
      link.setAttribute("download", "ImportSubjectClass.xlsx");
...
export default ImportSubjectClassModal;
