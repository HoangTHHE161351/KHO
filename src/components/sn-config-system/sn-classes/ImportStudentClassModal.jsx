...
import ResultTableStudentClass from "./ResultTableStudentClass";
...
const ImportStudentClassModal = ({ open, onClose, onSuccess }) => {
  ...
  const fetchImportData = async () => {
    setIsFetching(true);
    try {
      const response = await StudentService.importStudentClassService(
        resultData
      );
  ...
  const downloadExcel = () => {
    try {
      const url = "/excel/ImportStudentClass.xlsx";
      const link = document.createElement("a");
      link.href = url;
      link.setAttribute("download", "ImportStudentClass.xlsx");
...
export default ImportStudentClassModal;
