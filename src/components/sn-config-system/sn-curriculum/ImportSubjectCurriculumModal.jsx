...
import ResultTableSubjectCurriculum from "./ResultTableSubjectCurriculum";
...
const ImportSubjectCurriculumModal = ({ open, onClose, onSuccess }) => {
  ...
  const fetchImportData = async () => {
    setIsFetching(true);
    try {
      const response = await CurriculumService.importSubjectCurriculum(
        resultData
      );
  ...
  const downloadExcel = () => {
    try {
      const url = "/excel/ImportSubjectCurriculum.xlsx";
      const link = document.createElement("a");
      link.href = url;
      link.setAttribute("download", "ImportSubjectCurriculum.xlsx");
...
export default ImportSubjectCurriculumModal;
