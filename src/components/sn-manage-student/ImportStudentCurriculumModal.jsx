...
const ImportStudentCurriculumModal = ({ open, onClose }) => {
  ...
  const fetchImportData = async () => {
    setIsFetching(true);
    try {
      const response = await StudentService.importStudentCurriculumService(
        resultData
      );
  ...
  const downloadExcel = () => {
    try {
      const url = "/excel/ImportStudentCurriculum.xlsx";
      const link = document.createElement("a");
      link.href = url;
      link.setAttribute("download", "ImportStudentCurriculum.xlsx");
...
export default ImportStudentCurriculumModal;
